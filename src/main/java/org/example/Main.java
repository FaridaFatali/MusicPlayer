...
/**
 * Practice: <a href="https://www.youtube.com/watch?v=49eeLxc6xE4">...</a>
 *
 * @author Farida Fatali
 * Creating Music Player in Java
 */
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        albums.get(1).addToPlayList("Rap", playList1);
